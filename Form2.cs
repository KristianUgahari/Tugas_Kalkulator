...
namespace Calculator
{
    public partial class Form2 : Form
    {
        ...
        public event KalkulasiEventHandler KalkulatorSederhana;
        ...
        private void btnProses_Click(object sender, EventArgs e)
        {
            ...
            {
                KalkulatorSederhana(0, NilaiA, NilaiB);
            }
            else if (cbOperasi.SelectedIndex == 1)
            {
                KalkulatorSederhana(1, NilaiA, NilaiB);
            }
             else if (cbOperasi.SelectedIndex == 2)
            {
                KalkulatorSederhana(2, NilaiA, NilaiB);
            }
             else 
            {
                KalkulatorSederhana(3, NilaiA, NilaiB);
            }
        }
    }
}
